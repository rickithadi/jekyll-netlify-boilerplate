...
Not the prettiest huh, let's get that fixed. We'll do that with a[ cloudflare worker](https://workers.cloudflare.com/). 

1) Point your domain registrar's DNS to cloudflare

2) Set up DNS records on cloudflare
